...
//--------------------------------------------
// 첫번째 파라미터 : 시작 인덱스(index)
// 두번째 파라미터 : 두번째 인자로 종료 인덱스의 직전 인덱스값
//  ==> 시작 인덱스부터 종료 인덱스의 직전까지 값을 복사하여 반환합니다.


let arrForSlice = [1,2,3,4,5,];
let arrRes = arrForSlice.slice();
console.log('arrRes :: ',arrRes)
/*[출력] arrRes ::  [ 1, 2, 3, 4, 5 ]*/
console.log('arrRes1 :: ',arrRes.slice(1));
/*[출력] arrRes1 ::  [ 2, 3, 4, 5 ] */
console.log('arrRes2 :: ',arrRes.slice(1,3));
/*[출력] arrRes2 ::  [ 2, 3 ] */
